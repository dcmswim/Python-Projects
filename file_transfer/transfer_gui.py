...
class main_window(Frame):
    def __init__(self):
        ...
        self.buttonA = tk.Button(self, text = "Select input directory", command = lambda:filetransfer.select_input(self))
        ...
        self.buttonB = tk.Button(self, text = "Select output directory", command = lambda:filetransfer.select_output(self))
